...
const ImagenPortadaPaginas = ({ img, title, centered = true, textColor = 'white', yOffSiteIPad = '50%', height = '30vh', withMarginTop = true, heightOniPad = '20vh', heightOnIPhone = '25vh', yOffSiteiPhone='10%' }) => {
